...
const personalData = {
  ...
  timelineEvents: [
    ...
    },
    {
      ...
      title: "Fatherhood — Welcoming Aadvika (Daughter) & Aadhees (Son)",
      category: "family",
      ...
      summary: "Becoming a proud father to daughter Aadvika and son Aadhees. The ultimate chapter that redefined love, patience, and future purpose.",
      ...
      statsBadge: "Aadvika (Daughter) • Aadhees (Son) • Visa Bengaluru Memory",
      storyParagraphs: [
        "Nothing in life transforms a man like fatherhood. Holding his daughter Aadvika for the first time unlocked a level of tenderness, protective instinct, and unconditional love that words cannot capture. Seeing her bright smile, creative curiosity—like proudly showing her butterfly drawings while visiting her father at the Visa Bengaluru office—and watching her grow into a confident, kind young girl is one of life's greatest joys.",
        "When his son Aadhees arrived, the family circle was complete. Aadhees brought boundlessly energetic laughter, curiosity, and playful adventure into their daily routine.",
        "Being an active, present father—teaching them science concepts, reading bedtime stories, playing games, and instilling strong moral values—is Sanjeev's proudest and most sacred responsibility."
      ],
      takeaways: [
        "Fatherhood is the ultimate motivator for excellence, integrity, and patience",
        "Prioritizing presence over mere provision: creating cherished everyday memories like office visits and butterfly drawings",
